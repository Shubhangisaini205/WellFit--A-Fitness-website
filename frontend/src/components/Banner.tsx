...
import bannerPhoto from "../multimedia/wellfitBanner.png"
const Banner = () => {
  return (
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-20">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">
              Stronger every day with WellFit.
            </h1>
            <p className="mt-6 text-lg leading-8 text-white">
            Transform your body, transform your life. Get fit, feel great, and unleash your full potential with our expert guidance and support.
            </p>
