            ...
            {products.map((product,ind) => (
              <div key={ind} className="group relative">
                <div className="min-h-80 aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-80">
                  <video className="h-full w-full object-cover object-center lg:h-full lg:w-full" controls autoPlay muted loop>
                ...
                <div className="mt-4 flex justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500">Difficulty: {product.Difficulty}</p>
                  </div>
